    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="container max-w-6xl mx-auto px-4 py-20">
          ...
          {/* GROS BOUTON VERS LOVABLE */}
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-primary/5 border-2 border-primary/20 rounded-2xl p-12 mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4">
                Prêt à discuter de votre projet ?
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                Cliquez sur le bouton ci-dessous pour accéder au formulaire de contact
              </p>
              <a 
                href="https://prise-de-contact.lovable.app/" 
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary/90 transition-all transform hover:scale-105 shadow-lg"
              >
